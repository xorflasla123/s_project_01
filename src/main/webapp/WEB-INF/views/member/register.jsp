	...
	<div style="width:300px; margin: 0 auto;">
		<form id="fo" action="register" method="post">
			<table border="1" style="width:300px;">
				<tr>
					<td>
						<input size="30" type="text" name="id" placeholder="input id"><br>				
						<input size="30" type="password" name="pw" placeholder="input password"><br>				
						<input size="15" type="text" id="addr1" name="addr" placeholder="우편번호">
